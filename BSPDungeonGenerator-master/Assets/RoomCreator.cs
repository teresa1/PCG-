...
//        {
//            case 0:
//                return new Vector3((int)(transform.position.x + Random.Range(0, transform.localScale.x - 1)), transform.position.y, (int)transform.position.z);
//            case 1:
//                return new Vector3((int)(transform.position.x + transform.localScale.x), transform.position.y,
//                                   (int)(transform.position.z + Random.Range(0, transform.localScale.z - 1)));
//            case 2:
//                return new Vector3((int)(transform.position.x + Random.Range(1, transform.localScale.x - 2)), transform.position.y,
//                                   (int)(transform.position.z + transform.localScale.z));
//            case 3:
//                return new Vector3((int)(transform.position.x + 1), transform.position.y,
...
//        while (true)
//        {
//            if (_aNode == null) return null;

//            if (_aNode.getRoom() == null) return _aNode;
//            _aNode = _aNode.getParentNode();
//        }
//    }
